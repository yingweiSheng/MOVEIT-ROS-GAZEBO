...
static const rclcpp::Logger LOGGER =
  rclcpp::get_logger("laser_er7robot_servo_node");
...
int main(int argc, char** argv)
{
  ...
  auto node = std::make_shared<rclcpp::Node>("laser_er7robot_servo", options);
  ...
  auto servo_parameters =
      moveit_servo::ServoParameters::makeServoParameters(node,"laser_servo_config");
